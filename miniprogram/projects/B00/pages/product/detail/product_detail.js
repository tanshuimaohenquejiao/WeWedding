...
Page({
	...
	_loadDetail: async function () {
		...
		FootBiz.addFoot(product.PRODUCT_CATE_NAME, product.PRODUCT_TITLE);

	},

	bindFavTap: async function () {
		let product = this.data.product;
		await FavBiz.updateFav(this, this.data.id, this.data.isFav, product.PRODUCT_CATE_NAME, product.PRODUCT_TITLE);
	},
